...
* `iam_instance_profile` (optional)
  the name or ARN of an [IAM instance profile](http://docs.aws.amazon.com/IAM/latest/UserGuide/roles-usingrole-ec2instance.html) for providing credentials to the VM via the EC2 instance metadata service
